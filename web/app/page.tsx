    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-sans font-bold text-foreground mb-12 text-center">Featured Articles</h2>
                ...
                <Card className="h-full hover:shadow-lg transition-all cursor-pointer border-white/20 bg-white/20 glass rounded-2xl hover:scale-105">
                  <CardHeader>
                    <div className="flex items-start justify-between gap-2 mb-2">
                      <CardTitle className="line-clamp-2 text-lg font-sans">{article.title}</CardTitle>
                      <Badge
                        variant={
